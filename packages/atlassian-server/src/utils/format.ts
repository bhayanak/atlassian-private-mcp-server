...
export function formatJiraSearchResults(data: Record<string, unknown>, _baseUrl: string): string {
...
export function formatConfluencePage(page: Record<string, unknown>, baseUrl: string): string {
