...
import {
  getJiraIssueRemoteIssueLinksSchema,
  getJiraIssueRemoteIssueLinks,
} from './tools/jira/get-issue-remote-links.js';
import {
  getJiraIssueTypeMetaWithFieldsSchema,
  getJiraIssueTypeMetaWithFields,
} from './tools/jira/get-issue-type-meta.js';
import {
  getJiraProjectIssueTypesMetadataSchema,
  getJiraProjectIssueTypesMetadata,
} from './tools/jira/get-project-issue-types.js';
import { getIssueLinkTypes } from './tools/jira/get-issue-link-types.js';
import {
  getTransitionsForJiraIssueSchema,
  getTransitionsForJiraIssue,
} from './tools/jira/get-transitions.js';
...
import {
  searchJiraIssuesUsingJqlSchema,
...
import {
  getConfluencePageDescendantsSchema,
  getConfluencePageDescendants,
} from './tools/confluence/get-page-descendants.js';
import {
  getConfluencePageFooterCommentsSchema,
  getConfluencePageFooterComments,
} from './tools/confluence/get-footer-comments.js';
import {
  getConfluencePageInlineCommentsSchema,
  getConfluencePageInlineComments,
} from './tools/confluence/get-inline-comments.js';
import {
  getConfluenceCommentChildrenSchema,
  getConfluenceCommentChildren,
} from './tools/confluence/get-comment-children.js';
import { getConfluenceSpacesSchema, getConfluenceSpaces } from './tools/confluence/get-spaces.js';
import {
  getPagesInConfluenceSpaceSchema,
  getPagesInConfluenceSpace,
} from './tools/confluence/get-pages-in-space.js';
import {
  createConfluencePageSchema,
  createConfluencePage,
} from './tools/confluence/create-page.js';
import {
  updateConfluencePageSchema,
  updateConfluencePage,
} from './tools/confluence/update-page.js';
import {
  createConfluenceFooterCommentSchema,
  createConfluenceFooterComment,
} from './tools/confluence/create-footer-comment.js';
import {
  createConfluenceInlineCommentSchema,
  createConfluenceInlineComment,
} from './tools/confluence/create-inline-comment.js';
import {
  searchConfluenceUsingCqlSchema,
  searchConfluenceUsingCql,
} from './tools/confluence/search-content.js';
...
export function createServer(config: AppConfig): McpServer {
  ...
  server.tool(
    ...
    async ({ issueIdOrKey, expand }) => ({
      content: [
        {
          type: 'text',
          text: await getJiraIssue(jiraClient, { issueIdOrKey, expand }, jiraBaseUrl),
        },
      ],
    })
  );
  ...
  server.tool(
    ...
    async ({ issueIdOrKey }) => ({
      content: [
        { type: 'text', text: await getJiraIssueRemoteIssueLinks(jiraClient, { issueIdOrKey }) },
      ],
    })
  );
  ...
  server.tool(
    ...
    async ({ projectKeyOrId, issueTypeId }) => ({
      content: [
        {
          type: 'text',
          text: await getJiraIssueTypeMetaWithFields(jiraClient, { projectKeyOrId, issueTypeId }),
        },
      ],
    })
  );
  ...
  server.tool(
    ...
    async ({ projectKeyOrId }) => ({
      content: [
        {
          type: 'text',
          text: await getJiraProjectIssueTypesMetadata(jiraClient, { projectKeyOrId }),
        },
      ],
    })
  );
  ...
  server.tool(
    ...
    async ({ issueIdOrKey }) => ({
      content: [
        { type: 'text', text: await getTransitionsForJiraIssue(jiraClient, { issueIdOrKey }) },
      ],
    })
  );
  ...
  server.tool(
    ...
    async ({ query, maxResults }) => ({
      content: [
        { type: 'text', text: await lookupJiraAccountId(jiraClient, { query, maxResults }) },
      ],
    })
  );
  ...
  server.tool(
    ...
    async (args) => ({
      content: [
        {
          type: 'text',
          text: await searchJiraIssuesUsingJql(
            jiraClient,
            args,
            jiraBaseUrl,
  ...
  server.tool(
    ...
    async (args) => ({
      content: [
        { type: 'text', text: await getConfluencePage(confluenceClient, args, confluenceBaseUrl) },
      ],
    })
  );
  ...
  server.tool(
    ...
    async (args) => ({
      content: [
        {
          type: 'text',
          text: await getConfluencePageDescendants(confluenceClient, args, confluenceBaseUrl),
        },
      ],
    })
  );
  ...
  server.tool(
    ...
    async (args) => ({
      content: [
        { type: 'text', text: await getConfluencePageFooterComments(confluenceClient, args) },
      ],
    })
  );
  ...
  server.tool(
    ...
    async (args) => ({
      content: [
        { type: 'text', text: await getConfluencePageInlineComments(confluenceClient, args) },
      ],
    })
  );
  ...
  server.tool(
    ...
    async (args) => ({
      content: [
        {
          type: 'text',
          text: await getConfluenceSpaces(confluenceClient, args, confluenceBaseUrl),
        },
      ],
    })
  );
  ...
  server.tool(
    ...
    async (args) => ({
      content: [
        {
          type: 'text',
          text: await getPagesInConfluenceSpace(confluenceClient, args, confluenceBaseUrl),
        },
      ],
    })
  );
  ...
  server.tool(
    ...
    async (args) => ({
      content: [
        {
          type: 'text',
          text: await createConfluencePage(confluenceClient, args, confluenceBaseUrl),
        },
      ],
    })
  );
  ...
  server.tool(
    ...
    async (args) => ({
      content: [
        {
          type: 'text',
          text: await updateConfluencePage(confluenceClient, args, confluenceBaseUrl),
        },
      ],
    })
  );
  ...
  server.tool(
    ...
    async (args) => ({
      content: [
        {
          type: 'text',
          text: await createConfluenceFooterComment(confluenceClient, args, confluenceBaseUrl),
        },
      ],
    })
  );
  ...
  server.tool(
    ...
    async (args) => ({
      content: [
        {
          type: 'text',
          text: await createConfluenceInlineComment(confluenceClient, args, confluenceBaseUrl),
        },
      ],
    })
  );
  ...
  server.tool(
    ...
    async (args) => ({
      content: [
        {
          type: 'text',
          text: await searchConfluenceUsingCql(
            confluenceClient,
            args,
            confluenceBaseUrl,
            config.confluence.maxResults
          ),
        },
      ],
    })
  ...
  server.tool(
    ...
    async () => ({
      content: [
        { type: 'text', text: await atlassianUserInfo(jiraClient, jiraBaseUrl, confluenceBaseUrl) },
      ],
    })
  );
